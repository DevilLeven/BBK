  ...
  <div class="mint-swipe">
    ...
    <div class="mint-swipe-indicators" v-show="showIndicators">
      <div class="mint-swipe-indicator"
           ...
           :class="{ 'is-active': $index === index }" @click="toindex($index)"></div>
    </div>
  </div>
</template>
...
//          if (!options&&towards!=this.index) {
//            pageWidth = this.$el.clientWidth;
//            prevPage = pages[this.index];
//            nextPage = pages[towards];
//            var callback = () => {
//              removeClass(prevPage, 'is-active');
//              addClass(nextPage, 'is-active');
//              this.index = towards;
//                prevPage.style = '';
//                nextPage.style = '';
//            };
//            if (towards>this.index){
//              nextPage.style = 'display:block;transform:translateX(100%)';
//              prevPage.style = 'display:block';
//              this.translate(nextPage, 0, speed, callback);
//              this.translate(prevPage, -pageWidth, speed);
//            }else if(towards<this.index){
//              prevPage.style = 'display:block';
//              nextPage.style = 'display:block';
//              this.translate(prevPage, pageWidth, speed, callback);
